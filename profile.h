...
#define ROUTINE_COLORODDSQUARE		7
#define ROUTINE_COLOREVENSQUARE		8
...
FUNCTIONNAME(ROUTINE_COLORODDSQUARE,"colorOddSquare")
FUNCTIONNAME(ROUTINE_COLOREVENSQUARE,"colorEvenSquare")
